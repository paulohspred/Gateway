...
- `actions/checkout`, `actions/setup-go` e `actions/upload-artifact` referenciadas por commit SHA no workflow, evitando dependência de tags mutáveis durante o CI.
